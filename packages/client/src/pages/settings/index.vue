  ...
  setup(props, context) {
    ...
    const component = computed(() => {
      ...
      switch (page.value) {
        ...
        case "instance-mute":
          return defineAsyncComponent(() => import("./instance-mute.vue"));
        case "integration":
        ...
        case "menu":
          return defineAsyncComponent(() => import("./menu.vue"));
        case "sounds":
          return defineAsyncComponent(() => import("./sounds.vue"));
        case "custom-css":
          return defineAsyncComponent(() => import("./custom-css.vue"));
        case "deck":
        ...
        case "delete-account":
          return defineAsyncComponent(() => import("./delete-account.vue"));
